...
pub fn verify_eqaulity(
    ...
    let p_0_0 = verifier
        .allocate_point(b"0.0", statement.0 .0.compress())
        .unwrap();
    let p_0_1 = verifier
        .allocate_point(b"0.1", statement.0 .1.compress())
        .unwrap();
    let p_1_0 = verifier
        .allocate_point(b"1.0", statement.1 .0.compress())
        .unwrap();
    let p_1_1 = verifier
        .allocate_point(b"1.1", statement.1 .1.compress())
        .unwrap();
